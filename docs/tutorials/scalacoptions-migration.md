...
2. [New scalacOptions in Scala 3](#2---new-scalacoptions-in-scala-3)
3. [Unavailable scalacOptions in Scala 3](#3---unavailable-scalacoptions-in-scala-3)
...
For those scalacOptions, you just need to rename in case they have been renamed.
...
## 2 - New scalacOptions in Scala 3
### 1. Standard settings
...
## 3 - Unavailable scalacOptions in Scala 3
